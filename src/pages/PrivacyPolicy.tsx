      ...
      <div className="mx-auto max-w-[850px]">
        ...
        <article className="rounded-2xl border border-white/[0.1] bg-[#0c1423] p-6 sm:p-10">
          ...
          <div className="legal-copy mt-10 space-y-8">
            ...
            <section><h2>4. Google Forms i Google Sheets</h2><p>Formularz zgłoszeniowy jest obsługiwany przez Google Forms. Odpowiedzi są zapisywane w arkuszu Google Sheets należącym do administratora. Google może przetwarzać dane jako dostawca usługi zgodnie ze swoją <a href="https://policies.google.com/privacy" target="_blank" rel="noreferrer">polityką prywatności</a> oraz warunkami Google Workspace/Google Forms.</p><p>Usługa Google może powodować przetwarzanie danych poza Europejskim Obszarem Gospodarczym na zasadach opisanych przez Google, w tym z zastosowaniem odpowiednich mechanizmów transferu wymaganych przez RODO.</p></section>
            ...
            <section><h2>7. Cookies i technologie zewnętrzne</h2><p>Strona nie prowadzi własnej analityki i nie używa marketingowych plików cookies. Osadzenia YouTube oraz formularz Google mogą korzystać z własnych technologii Google po wybraniu odpowiedniej funkcji. Przed otwarciem formularza strona informuje o przekazaniu użytkownika do usługi Google.</p></section>
