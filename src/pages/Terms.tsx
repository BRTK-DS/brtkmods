      ...
      <div className="mx-auto max-w-[850px]">
        ...
        <article className="rounded-2xl border border-white/[0.1] bg-[#0c1423] p-6 sm:p-10">
          ...
          <div className="legal-copy mt-10 space-y-8">
            <section><h2>1. Postanowienia ogólne</h2><p>Regulamin określa zasady korzystania z serwisu BRTKMods.com, którego właścicielem i administratorem jest Bartosz Siadlak, osoba prywatna. Serwis prezentuje portfolio modów Minecraft oraz umożliwia przesłanie zapytania dotyczącego współpracy.</p></section>
